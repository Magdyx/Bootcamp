...
1. Your instructor will provide you with the project ID. You will need this project ID for [step 9](#environment-files).
...
2. Once your new project loads, select the "Manage" tab from the Project's main page. You will see your Project ID under the "General" tab as shown below. You will need this project ID for [step 9](#environment-files).
